...
muso1 = MAP(Bezier(puntiContolloMuso1))(Dom1D)


puntiContolloMuso2 = [[1.8,0.5],[1.8,0.9],[1.8,0.6],[1.9,1.1]]
muso2 = MAP(Bezier(puntiContolloMuso2))(Dom1D)


muso = STRUCT([muso0,muso1,muso2])
#--------------------------------------------------------------------
...
curvaParabrezzaY3= MAP(Bezier(puntiControlloY3))(Dom1D)

puntiControlloY4 = [[0,2.7],[1.9,2.5],[2,1.85],[1.35,0.5]]
curvaParabrezzaY4= MAP(Bezier(puntiControlloY4))(Dom1D)
...
vistaAlta = STRUCT([
                    ...
                    curvaParabrezzaY3,curvaParabrezzaY4,curvaParabrezzaY5,
...
modello = COLOR(WHITE)(STRUCT([modelloX,macchinaFrontTraslata,modelloYTraslato,ruote,volanteTraslato]))
VIEW(modello)
