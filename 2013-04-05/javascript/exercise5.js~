...
star1 = T([1,2])([20.89,2.5+47.5+2.5])(ramp1floor)
...
VIEW(STRUCT([building,floor0,floor1,floor2,floor3,floor4,south,west,east,north,windowSouth,windowNorth,windowEast,buildingBase,star1,stair2,stair3]))
