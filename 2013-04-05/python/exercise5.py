...
#Prima rampa
ramp1floor = STRUCT(NN(10)([step3D,T([1,3])([depth,raiser])]))

#Prima rampa traslata
stair1 = T([1,2])([20.89,2.5+47.5+2.5])(ramp1floor)

#Scala per il secondo piano
depth2 = 3.16;
raiser2 = 2.05;
...
#Seconda rampa
ramp2floor = STRUCT(NN(12)([step3D_2,T([1,3])([depth2,raiser2])]))

#Seconda rampa traslata
stair2 = T([1,2,3])([10.5,2.5+47.5+2.5,25+1])(ramp2floor)

ramp3floor = STRUCT(NN(12)([step3D_2,T([1,3])([depth2,raiser2])]))
stair3 = T([1,2,3])([57.07,2.5+47.5+2.5,25+1+24+1])(ramp3floor)

VIEW(STRUCT([building,floor0,floor1,floor2,floor3,floor4,south,west,east,north,windowSouth,windowNorth,windowEast,buildingBase,stair1,stair2,stair3]))
