...
//****************	ESERCIZIO 4	****************//
function creaPrimoAgglomerato(c,maxNumero){
...
//Print the cluster of buildings 
function creaSecondoAgglomerato(c,maxNumero){
...
var numCasePrimo = (4*Math.random()+1);
var numCaseSecondo = (4*Math.random()+1);
